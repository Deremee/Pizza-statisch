...
function Header() {
  //const style = { color: "red", fontSize: "48px", textTransform: "uppercase" }; This is internal styling.
  const style = {};
  return (
    <header className="header">
      <h1 style={style}>Derem's Fast Pizza Co.</h1>
    </header>
  );
}
...
function Order({ closedHour, openHour }) {
  return (
    <div className="order">
      <p>
        We're open from {openHour}:00 until {closedHour}:00. Come visit us or
        order online.
      </p>
